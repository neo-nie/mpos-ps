...
function TB_show(caption, url) { //function called when the user clicks on a thickbox link
	try {
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif'){//code to show images
			...
			$("#TB_window").append("<img id='TB_Image' src='"+url+"' width='"+imgPreloader.width+"' height='"+imgPreloader.height+"' alt='"+caption+"'/>"+ "<div id='TB_caption'>"+caption+"</div><div id='TB_closeWindow' class=‘linkbtn1’><a href='#' id='TB_closeWindowButton'>关闭</a></div>"); 
		...
		if(urlType == '.htm' || urlType == '.html'){//code to show html pages
			...
			$("#TB_window").append("<div id='TB_closeAjaxWindow' class=‘linkbtn1’><a href='#' id='TB_closeWindowButton'><img src='../images/shut-down.gif' width='24' height='24'></a></div><div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;'></div>");
			$("#TB_closeWindowButton").click(TB_remove);
